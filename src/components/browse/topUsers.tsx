        ...
        topUsers.map((user, i) => {
          ...
          return (
            <div
              key={i}
              className={
                " flex align-middle  justify-between cursor-pointer rounded-md border-4 border-slate-900 bg-slate-700 p-2 mx-5 drop-shadow-lg"
              }
            >   
            ...
            <div className="relative mb-2">
              ...
              <h1 className=" align-middle">Total: {user.likes}</h1>
            </div>
          );
        })}
  </>
