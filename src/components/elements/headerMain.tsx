  ...
  return (
    <header className=" grid grid-cols-12 py-5 ">
      ...
      >
        <Link
          href="/"
          className="relative inline-block h-12 w-[15%]  rounded-l-lg bg-purple-400 py-2 text-center  font-mono  text-sm py-4  font-bold leading-none text-purple-600  transition duration-300 hover:bg-purple-600 hover:text-white hover:shadow-lg"
        >
          NextClip
        ...
        <button
          onClick={handleUrl}
          className="group relative inline-block h-12 w-[9%] rounded-r-lg bg-purple-600 py-2 text-xs align-top font-semibold text-white ring-purple-400 transition duration-300 hover:ring-2"
        >
          Search
      ...
      {!sessionData ? (
        ...
        <div className="col-start-10 -ml-9 col-end-13  rounded-lg mr-10 flex bg-gray-500 justify-end  ">
          <button
            className="  px-2 py-3  font-semibold leading-none text-sm text-white no-underline transition "
            onClick={() => void signOut()}
            >
          Sign Out
          </button>
          <Link href="/browse" className="py-[1.05rem] text-sm px-1 leading-none font-semibold text-white no-underline transition ">
            Browse
          </Link>
          {name && name[0] && <h1 className="py-3 px-1 hidden">{name[0]}</h1>}
            <div >
